                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-700 dark:text-gray-200 leading-relaxed max-w-3xl mx-auto">
                            Yazın serinletici mendiller, güneş kremleri, kağıt yelpazeler; kışın el ısıtıcıları, rüzgarlık ve sıcak içecekler.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            { src: './ruzgarlik.jpg', alt: 'Rüzgarlık', title: 'Rüzgarlık' },
